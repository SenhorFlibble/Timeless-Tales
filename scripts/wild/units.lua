...
-- Define unit-types.
--
DefineUnitType("unit-grunt", { Name = _("Hobgoblin Warrior"),
  Image = {"file", "wild/units/warrior.png", "size", {98, 98}},
...
DefineUnitType("unit-peon", { Name = _("Goblin Artisan"),
  Image = {"file", "wild/units/goblin_worker.png", "size", {72, 72}},
  ...
  Coward = true,
  CanGatherResources = {
   {"file-when-loaded", "wild/units/goblin_worker_with_gold.png",
    "resource-id", "gold",
    "resource-capacity", 100,
    "wait-at-resource", 150,
    "wait-at-depot", 150},
   {"file-when-loaded", "wild/units/goblin_worker_with_wood.png",
    "resource-id", "wood",
    "resource-capacity", 100,
    "resource-step", 2,
    "wait-at-resource", 24,
...
DefineUnitType("unit-catapult", { Name = _("War Machine"),
  Image = {"file", "wild/units/goblin_war_machine.png", "size", {72, 72}},
  ...
  BasicDamage = 80, PiercingDamage = 0, Missile = "missile-catapult-blaze",
...
DefineUnitType("unit-catapult-super", { Name = _("War Machine"),
...
DefineUnitType("unit-ogre", { Name = _("Giant Troll"),
...
DefineUnitType("unit-axethrower", { Name = _("Spear Thrower"),
  Image = {"file", "wild/units/spearthrower.png", "size", {104, 104}},
  Animations = "animations-human-archer", Icon = "icon-axethrower",
  ...
  BasicDamage = 3, PiercingDamage = 6, Missile = "missile-spear",
  MaxAttackRange = 4,
  Priority = 50,
  Points = 60,
  Demand = 1,
  Corpse = "unit-orc-body",
  Type = "land",
  RightMouseAction = "attack",
  CanAttack = true,
  CanTargetLand = true, CanTargetSea = true, CanTargetAir = true,
...
DefineUnitType("unit-death-knight", { Name = _("Dark Druid"),
  Image = {"file", "wild/units/geomancer.png", "size", {74, 74}},
  Animations = "animations-dark-druid", Icon = "icon-death-knight",
...
DefineUnitType("unit-goblin-sappers", { Name = _("Sapper Cart"),
  Image = {"file", "wild/units/cart.png", "size", {56, 56}},
  ...
  BasicDamage = 4, PiercingDamage = 2, Missile = "missile-spear",
  MaxAttackRange = 1,
  Priority = 55,
  Points = 100,
  Demand = 1,
...
DefineUnitType("unit-berserker", { Name = _("Big Game Hunter"),
  Image = {"file", "wild/units/spearthrower.png", "size", {104, 104}},
  Animations = "animations-human-archer", Icon = "icon-berserker",
  Costs = {"time", 70, "gold", 500, "wood", 50},
  Level = 2,
  Speed = 10,
  HitPoints = 50,
...
DefineUnitType("unit-zeppelin", { Name = _("Goblin Glider"),
  Image = {"file", "wild/units/glider.png", "size", {100, 100}},
  Animations = "animations-balloon", Icon = "icon-zeppelin",
...
DefineUnitType("unit-quick-blade", { Name = _("Blade Lord"),
  Image = {"file", "neutral/units/thane.png", "size", {72, 72}},
...
DefineUnitType("unit-sharp-axe", { Name = _("Sharp Shooter"),
  Image = {"file", "wild/units/goblin_archer.png", "size", {72, 72}},
  Animations = "animations-human-archer", Icon = "icon-sharp-axe",
  Costs = {"time", 70, "gold", 500, "wood", 50},
  Speed = 10,
  HitPoints = 120,
  DrawLevel = 40,
  ...
  Armor = 5, BasicDamage = 10, PiercingDamage = 18, Missile = "missile-goblin-arrow",
  MaxAttackRange = 5,
  Priority = 55,
  Points = 120,
  Demand = 1,
...
DefineUnitType("unit-skeleton", { Name = _("Skeleton"),
  Image = {"file", "neutral/units/skeleton.png", "size", {82, 82}},
  Animations = "animations-skeleton-warrior", Icon = "icon-skeleton",
  Speed = 8,
  HitPoints = 40,
  DrawLevel = 40,
  TileSize = {1, 1}, BoxSize = {31, 31},
...
DefineUnitType("unit-pig-farm", { Name = _("Hut"),
  Image = {"file", "wild/buildings/dwelling.png", "size", {64, 64}},
...
DefineUnitType("unit-orc-barracks", { Name = _("Battle Halls"),
  Image = {"file", "wild/buildings/battle_halls.png", "size", {96, 96}},
...
DefineUnitType("unit-altar-of-storms", { Name = _("Shrine of Ancients"),
  Image = {"size", {96, 96}},
...
DefineUnitType("unit-orc-watch-tower", { Name = _("Lookout Post"),
  Image = {"file", "wild/buildings/tower1.png", "size", {64, 64}},
...
DefineUnitType("unit-ogre-mound", { Name = _("Lair"),
  Image = {"file", "wild/buildings/lair.png", "size", {96, 96}},
...
DefineUnitType("unit-alchemist", { Name = _("Alchemist"),
  Image = {"file", "wild/buildings/alchemist.png", "size", {96, 96}},
...
DefineUnitType("unit-dragon-roost", { Name = _("Dread Wyrm Lair"),
  Image = {"size", {96, 96}},
...
DefineUnitType("unit-orc-shipyard", { Name = _("Docks"),
  Image = {"file", "wild/buildings/shipyard.png", "size", {96, 96}},
...
DefineUnitType("unit-great-hall", { Name = _("Hall of Elders"),
  Image = {"file", "wild/buildings/hall.png", "size", {128, 128}},
...
DefineUnitType("unit-troll-lumber-mill", { Name = _("Forest Lodge"),
  Image = {"file", "wild/buildings/lodge.png", "size", {96, 96}},
...
DefineUnitType("unit-orc-foundry", { Name = _("Foundry"),
  Image = {"file", "wild/buildings/foundry.png","size", {96, 96}},
...
DefineUnitType("unit-temple-of-the-damned", { Name = _("Skull Tower"),
  Image = {"file", "wild/buildings/skull_tower.png", "size", {96, 96}},
...
DefineUnitType("unit-orc-blacksmith", { Name = _("Bladesmith"),
  Image = {"file", "wild/buildings/bladesmith.png", "size", {96, 96}},
...
DefineUnitType("unit-orc-refinery", { Name = _("Refinery"),
  Image = {"file", "wild/buildings/refinery.png", "size", {96, 96}},
...
DefineUnitType("unit-orc-oil-platform", { Name = _("Oil Platform"),
  Image = {"file", "wild/buildings/oil_platform.png", "size", {96, 96}},
...
DefineUnitType("unit-stronghold", { Name = _("Seat of Ancients"),
  Image = {"file", "wild/buildings/seat.png", "size", {128, 128}},
...
DefineUnitType("unit-fortress", { Name = _("Hall of Forebears"),
  Image = {"file", "wild/buildings/forebears.png", "size", {128, 128}},
...
DefineUnitType("unit-orc-start-location", { Name = _("Start Location"),
  Image = {"file", "wild/o_startpoint.png", "size", {32, 32}},
  NumDirections = 1,
...
DefineUnitType("unit-orc-guard-tower", { Name = _("Sentry Tower"),
  Image = {"file", "wild/buildings/tower2.png", "size", {64, 64}},
